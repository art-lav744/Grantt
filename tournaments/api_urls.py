...
urlpatterns = [
    ...
    path('staff/users/', views.StaffAssignableUsersView.as_view(), name='api_staff_users'),
    path('staff/roles/', views.StaffRoleAssignmentView.as_view(), name='api_staff_roles'),
